...
/***/ function(module, exports, __webpack_require__) {
	...
	var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(item) {
	  return function (dispatch) {
	    return APIUtil.fetchSearchGiphys(item).then(function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    fetchSearchGiphys: function fetchSearchGiphys(item) {
	      return dispatch((0, _giphy_actions.fetchSearchGiphys)(item));
	    }
	  };
	};
	  ...
	  _createClass(GiphysSearch, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_giphys_index2.default, { items: this.props.giphys })
	      );
	    }
	  }]);
	...
	var GiphysIndex = function GiphysIndex(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    items.map(function (item, i) {
	      return _react2.default.createElement("img", { key: i, src: item.images.original.url, alt: "picture" });
	    })
	  );
	};
