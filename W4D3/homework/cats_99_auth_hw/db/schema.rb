...
ActiveRecord::Schema.define(version: 20161208055055) do
  ...
  create_table "multi_sessions", force: :cascade do |t|
    t.integer  "user_id",       null: false
  ...
  add_index "multi_sessions", ["user_id"], name: "index_multi_sessions_on_user_id", using: :btree
