...
ActiveRecord::Schema.define(version: 20161201012719) do
  ...
  add_index "taggings", ["topic_id", "shortened_url_id"], name: "index_taggings_on_topic_id_and_shortened_url_id", unique: true, using: :btree
